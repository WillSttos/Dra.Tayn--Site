...
const PeriodontiaIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
        ...
        <path style={{fill: 'hsl(var(--primary))'}} d="M256.01,437.556L256.01,437.556h-0.016c-118.606,0-72.186-103.997-255.979-95.997L0,511.992h511.996 V341.559C328.187,333.559,374.623,437.556,256.01,437.556z"></path>
        <path style={{fill: 'hsl(var(--secondary))'}} d="M469.902,180.875c22-53.171-3.25-114.123-56.436-136.138c-16.031-6.625-32.75-8.968-48.938-7.531 c-10.404-12.438-23.904-22.609-39.936-29.25c-53.178-22.015-114.13,3.25-136.145,56.436c-6.031,14.609-8.516,29.796-7.828,44.609 l3,74.842c-16.14,19.343-59.999,157.339-13.578,176.557c14.609,6.047,88.826-108.403,103.178-102.575 c14.342,5.828-14.102,139.449,0.5,145.48c46.436,19.219,112.902-109.419,115.152-134.512l55.061-50.828 C454.871,207.984,463.871,195.485,469.902,180.875z"></path>
    </svg>
);
